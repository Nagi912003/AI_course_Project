...
def pick_best_move_according_to_score_only(board, piece):
	valid_locations = get_valid_locations(board)
	best_score = -10000
...
def pick_best_move_with_alpha_beta_pruning(board, piece):
	valid_locations = get_valid_locations(board)
	...
	for col in valid_locations:
		...
		temp_board = board.copy()
		drop_piece(temp_board, row, col, piece)
		score = minimax(temp_board, 3, alpha, beta, False)[1]  ##############  with alpha-beta pruning
		# score = score_position(temp_board, piece)
		if score > best_score:
			best_score = score
			best_col = col
			...
			while not game_over:
				...
				if turn == AI and not game_over:
					...
					if difficulty == 'Easy':
						...
						col = pick_best_move_according_to_score_only(board, AI_PIECE)
					elif difficulty == 'Hard':
						# Hard - AI chooses according to minimax 3 score with alpha beta pruning
						col = pick_best_move_with_alpha_beta_pruning(board, AI_PIECE)
